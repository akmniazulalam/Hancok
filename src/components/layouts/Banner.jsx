...
import { FaAngleDoubleRight, FaFacebookF, FaLinkedinIn, FaTwitter, FaInstagram } from "react-icons/fa";
    ...
    <div
      ...
      <Container>
        ...
        <Heading
          ...
          as={"h1"}
          className={"text-6xl font-semibold py-[18px] inline-block relative after:absolute after:h-1 after:w-[90px] after:bg-white after:content-[''] after:bottom-[21px] after:-right-[115px]"}
        />
        ...
        <button className="flex items-end gap-x-2 font-oswald text-base text-textC bg-white py-[15px] px-[25px] mt-14">View More <FaAngleDoubleRight className="text-[21px]"/></button>
